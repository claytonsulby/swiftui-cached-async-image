...
struct CachedAsyncImage_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            List {
                CachedAsyncImage(url: URL(string: "http://via.placeholder.com/160x90&text=hello"))
                    .previewLayout(.sizeThatFits)
                
                CachedAsyncImage(url: URL(string: "http://via.placeholder.com/160x90&text=hello"), content: { image in
                    image
                        .resizable()
                }, placeholder: {
                    ProgressView()
